        ...
        <aside class="w-64 absolute h-full">
            ...
            <nav class="mt-8">
                <ul class="space-y-4 px-4">
                    <li>
                        <a href="/admin" class="flex items-center gap-3 px-4 py-3 hover:bg-zinc-900 rounded-xl shadow-md">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div>
                        ...
                        <select class="w-full px-3 py-2 bg-zinc-900 rounded border border-gray-700">
                            <option>Today</option>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Search by name or ID" 
                               class="w-full px-3 py-2 bg-zinc-900 rounded border border-gray-700">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div class="bg-zinc-900 p-4 rounded-xl">
                        <div class="text-sm text-gray-400">Total Present</div>
                        <div class="text-2xl font-semibold text-green-400">130</div>
                    </div>
                    <div class="bg-zinc-900 p-4 rounded-xl">
                        <div class="text-sm text-gray-400">Total Absent</div>
                    ...
                    <div class="bg-zinc-900 p-4 rounded-xl">
                        <div class="text-sm text-gray-400">On Leave</div>
                ...
                <div class="bg-zinc-900 rounded-xl overflow-hidden">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-800">
                            <tr class="hover:bg-zinc-700">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="w-8 h-8 rounded-full bg-black flex items-center justify-center mr-3">
                                            JD
                                        </div>
                                        <div>
                                ...
                                <td class="px-6 py-4">
                                    <span class="bg-green-900 text-green-300 px-2 py-1 rounded text-sm">Present</span>
                                </td>
                                <td class="px-6 py-4">
                                    <button class=" hover:text-black">View Details</button>
                                </td>
                            </tr>
                            <tr class="hover:bg-zinc-700">
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <span class="bg-yellow-900 text-yellow-300 px-2 py-1 rounded text-sm">Late</span>
                                </td>
                                <td class="px-6 py-4">
                            ...
                            <tr class="hover:bg-zinc-700">
                                ...
                                <td class="px-6 py-4">--</td>
                                <td class="px-6 py-4">
                                    <span class="bg-red-900 text-red-300 px-2 py-1 rounded text-sm">Absent</span>
                                </td>
                                <td class="px-6 py-4">
                                    <button class="text-blue-400 hover:text-blue-300">View Details</button>
                                </td>
                    ...
                    <div class="bg-zinc-900 px-6 py-4 flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <button class="px-3 py-1 rounded border border-gray-700 text-gray-400 hover:text-white">Previous</button>
                            <button class="px-3 py-1 rounded bg-blue-600 text-white">1</button>
                            <button class="px-3 py-1 rounded border border-gray-700 text-gray-400 hover:text-white">2</button>
                            <button class="px-3 py-1 rounded border border-gray-700 text-gray-400 hover:text-white">3</button>
                            <button class="px-3 py-1 rounded border border-gray-700 text-gray-400 hover:text-white">Next</button>
                        </div>
                    </div>
                </div>
            </div>
