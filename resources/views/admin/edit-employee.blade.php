<x-layout>
    <div class="flex min-h-screen flex-col justify-center px-6 lg:px-16 pt-12">
        ...
        <div class="sm:mx-auto sm:w-full max-w-4xl text-center mb-8">
            ...
            <p class="text-zinc-300 mt-1">Update the details below to edit the employee.</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="first_name" id="first_name" required
                            ...
                            class="mt-2 block w-full rounded-xl bg-zinc-900 border border-gray-700 px-4 py-3 placeholder-zinc-400"
