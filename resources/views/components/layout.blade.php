        ...
        @if (auth()->check() &&
            ...
            @if (auth()->user()->role === 'admin')
                ...
                <button onclick="toggleSidebar()"
                    ...
                    <div class="w-[50%] h-[2px] bg-white rounded-md transition-all duration-300 origin-center my-1">
                    </div>
                ...
                <div id="sidebar-wrapper" class="fixed hidden md:block">
                    <!-- Overlay -->    
                    <div id="overlay" class="hidden md:hidden fixed inset-0 bg-black bg-opacity-50"
